...
// TestUserHandlerGetAll is a mocktest for GetAll method of interface UserService
func TestUserhandlerGetAll(t *testing.T) {
	mockUserService.On("GetAll", mock.Anything).Return([]*model.User{}, nil).Twice()
	handler := NewGRPCUserHandler(mockUserService)
...
// TestUserHandlerSignUp is a mocktest for SignUp method of interface UserService
...
// TestUserHandlerLogin is a mocktest for Login method of interface UserService
...
// TestUserHandlerRefreshTokenPair is a mocktest for RefreshTokenPair method of interface UserService
...
// TestUserHandlerDelete is a mocktest for Delete method of interface UserService
